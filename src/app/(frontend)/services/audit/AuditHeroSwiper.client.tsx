          ...
          <SwiperSlide key={slide.src}>
            <div className="relative h-[420px] md:h-[700px]">
              ...
              <div className="absolute inset-0 z-20">
                <div className="mx-auto flex h-full max-w-7xl items-center px-6 text-white md:px-0 lg:px-0">
                  <div className="">
                    <p className="text-3xl md:text-6xl font-bold leading-tight drop-shadow-[2px_4px_10px_rgba(0,0,0,0.5)]">
                      {slide.title}
                      <br />
                      {slide.titleSecondLine}
                    </p>

                    <div className="mb-4 md:mb-6 bg-[linear-gradient(90deg,#E4763D,#652D8E03)] rounded-xl py-3 px-12 inline-flex flex-col gap-1 mt-5">
