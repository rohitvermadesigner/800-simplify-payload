...
const packages = [
  ...
  },
  {
    name: 'ADVANCED',
    price: '1,200',
    description: 'For Growing Business seeking better controls and financial insights.',
    features: [
      'Accounting',
      'VAT Returns Filing',
      'Email Support',
...
const Package = () => {
  ...
  return (
    <section>
      <div className="relative max-w-7xl mx-auto pt-8 md:pt-16 px-4 md:px-0" id="packages">
        <div className="lg:px-64 text-center">
          ...
          <p className="text-[#4A5565] md:px-4 font-medium mt-2">
            Choose the level of financial oversight that matches your operations. Upgrade anytime.
          </p>
        </div>
            ...
            return (
              <SwiperSlide key={plan.name} className="!h-auto py-2">
                ...
                >
                  ...
                  <h3 className="text-[#2F3B51] text-[1.2rem] font-bold mb-2">{plan.name}</h3>
                  <p className="text-[#4A5565] text-[0.9rem] mb-4 font-medium">Starting from</p>
                  <div className="mb-4">
                    ...
                    <span className="text-[#4A5565] text-[0.9rem]">/month</span>
                  </div>
                  ...
                  <div className="list-box">
                    <ul className="text-[#314158] text-left mb-6">
                      {featureList.map((feature) => (
                        <li key={feature} className="flex items-start gap-2 mb-3 text-[0.9rem]">
                          <span
                      ...
                      {Array.from({ length: plan.hiddenRows ?? 0 }).map((_, index) => (
                        <li
                    ...
                    {isElite && (
                      <button
                        ...
                        onClick={() => setShowEliteFeatures((current) => !current)}
                      >
